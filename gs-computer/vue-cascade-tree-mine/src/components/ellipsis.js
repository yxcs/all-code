function setEllipsis(el, binding, vnode) {
  ...
  // 设置文本超出指定行数后隐藏样式
  let textLineHeightNum = isNaN(parseInt(textLineHeight)) ? 20 : parseInt(textLineHeight)
  textLineHeightNum = textLineHeightNum < 10 ? 10 : textLineHeightNum
  const limitHeight = textLineHeightNum * lineNum;
  if (limitHeight) {
